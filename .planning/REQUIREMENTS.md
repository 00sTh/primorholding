...
- [ ] **SITE-01**: Navbar fixa com logo Primor Holding, links ancora para secoes, e botao CTA de contato
- [ ] **SITE-02**: Secao Hero com headline impactante, subtitulo descritivo e CTA para contato
- [ ] **SITE-03**: Footer com nome da empresa, CNPJ (placeholder ate fornecido), links para paginas legais e redes sociais
...
- [ ] **SITE-08**: Botao flutuante de WhatsApp visivel em todas as paginas, com numero configuravel
...
- [ ] **SITE-11**: Banner/modal de consentimento de cookies conforme LGPD -- com opcao de aceitar/recusar, persistencia da escolha
- [ ] **SITE-12**: Animacoes de entrada com framer-motion -- elementos aparecem ao rolar a pagina
...
| SITE-11 | Phase 2 | Pending |
| SITE-12 | Phase 2 | Pending |
