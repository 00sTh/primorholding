...
export default function TestimonialEditForm({ testimonial }: Props) {
  ...
  return (
    <div className="max-w-2xl">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="font-serif text-3xl text-cream">Editar Depoimento</h1>
      </div>
      ...
      <form action={formAction} className="space-y-5">
        ...
        <div>
          ...
          {testimonial.photoUrl && (
            <div className="mb-2">
              <p className="text-slate text-xs mb-1">Foto atual:</p>
              <Image
