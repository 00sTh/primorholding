        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card-dark p-8 md:p-12 prose prose-invert max-w-none">
            <div className="space-y-8 text-[#6B6057] text-sm leading-relaxed">
              <div>
                <h2 className="text-[#1C1510] font-serif text-xl font-semibold mb-3">1. Informações que coletamos</h2>
              ...
              <div>
                <h2 className="text-[#1C1510] font-serif text-xl font-semibold mb-3">2. Como usamos suas informações</h2>
              ...
              <div>
                <h2 className="text-[#1C1510] font-serif text-xl font-semibold mb-3">3. Compartilhamento de dados</h2>
              ...
              <div>
                <h2 className="text-[#1C1510] font-serif text-xl font-semibold mb-3">4. Seus direitos</h2>
