        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card-dark p-8 md:p-12">
            <div className="space-y-8 text-[#8B8075] text-sm leading-relaxed">
              <div>
                <h2 className="text-[#F0EBE1] font-serif text-xl font-semibold mb-3">1. Aceitação dos Termos</h2>
                <p>Ao acessar e usar este site, você concorda com estes Termos de Uso. Se não concordar, por favor, não utilize nosso site.</p>
              </div>
              <div>
                <h2 className="text-[#F0EBE1] font-serif text-xl font-semibold mb-3">2. Uso do Site</h2>
              ...
              <div>
                <h2 className="text-[#F0EBE1] font-serif text-xl font-semibold mb-3">3. Propriedade Intelectual</h2>
              ...
              <div>
                <h2 className="text-[#F0EBE1] font-serif text-xl font-semibold mb-3">4. Contato</h2>
